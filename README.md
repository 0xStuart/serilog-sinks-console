### Fork:
This fork adds the option to attach a System.Threading.Channels Reader/Writer.
It allows you to attach external consoles / Ansi Terminals.

```
var logChannel = Channel.CreateUnbounded<(LogEvent, byte[])>();
```
```
Log.Logger = new LoggerConfiguration()
.Enrich.FromLogContext()
.WriteTo.ConsoleChannelWriter(logChannel)
.CreateLogger();
```
